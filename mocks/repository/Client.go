...
func (_m *Client) Find(filter interface{}, dest interface{}) error {
...
func (_m *Client) FindByID(id primitive.ObjectID, dest interface{}) error {
...
func (_m *Client) FindOne(filter interface{}, dest interface{}) error {
	ret := _m.Called(filter, dest)
...
func (_m *Client) InsertMany(data []interface{}) error {
	ret := _m.Called(data)
...
func (_m *Client) InsertOne(data interface{}) (primitive.ObjectID, error) {
	ret := _m.Called(data)
...
func (_m *Client) UpdateOne(filter interface{}, update map[string]interface{}) error {
